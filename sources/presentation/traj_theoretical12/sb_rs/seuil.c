...
int seuil_deter(double *y, par_type *pp, double y0[DIM], double t0, double t_end, double abs_tol, double rel_tol){
  ...
  while (t < t1){
    ...
    if((y[4]<1e-6) && (seuil_I1_1 == -100.0)) seuil_I1_1=t;
    if((y[5]<1e-6) && (seuil_I2_1 == -100.0)) seuil_I2_1=t;

    if((y[4]<1e-7) && (seuil_I1_2 == -100.0)) seuil_I1_2=t;
    if((y[5]<1e-7) && (seuil_I2_2 == -100.0)) seuil_I2_2=t;

    if((y[4]<1e-8) && (seuil_I1_3 == -100.0)) seuil_I1_3=t;
    if((y[5]<1e-8) && (seuil_I2_3 == -100.0)) seuil_I2_3=t;
