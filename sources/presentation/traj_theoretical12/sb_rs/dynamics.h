...
#define DIM 6 /*dimension du systeme non lineaire a integrer*/
...
#define PRINT_POINC	"%f\t%g\t%g\t%g\t%g\t%g\t%g\n", param.s, yp[0], yp[1], yp[2], yp[3], yp[4], yp[5]	
...
#define PRINT_FAIL_TRAJ	"NaN\tNaN\tNaN\tNaN\tNaN\tNaN\tNaN\n"

#define PRINT_FAIL_POINC	"%f\tNaN\tNaN\tNaN\tNaN\tNaN\tNaN\n", param.e
