...
//	#define PRINT_TRAJ "%f\t%.5e\t%.5e\t%.5e\t%.5e\t%.5e\t%.5e\n", t, y[0], y[1], y[2], y[3], y[4], y[5]
	...
	#define PRINT_SUMMARY	"%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%d\n", param.x, traj_min, mean_min, sd_min, maxmin, minmax, mean_max, sd_max, traj_max, phasemin, mean_T, sd_T, phasemax, categorie(input,nb_max)
