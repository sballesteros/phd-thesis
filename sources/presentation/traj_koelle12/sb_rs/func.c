...
int func (double t, const double y[], double f[], void *params) {
	...
	/*R1*/ f[1] = (1.0-s)*(b01*(1+e*cos(2*M_PI*t)))*y[0]*(y[4]+m1) -(b02*(1+e*cos(2*M_PI*t)))*y[1]*(y[5]+m2) -u*y[1];
	/*R2*/ f[2] = (1.0-s)*(b02*(1+e*cos(2*M_PI*t)))*y[0]*(y[5]+m2) -(b01*(1+e*cos(2*M_PI*t)))*y[2]*(y[4]+m1) -u*y[2];
	/*R12*/ f[3] =  s*(b01*(1+e*cos(2*M_PI*t)))*y[0]*(y[4]+m1) +s*(b02*(1+e*cos(2*M_PI*t)))*y[0]*(y[5]+m2) +(b02*(1+e*cos(2*M_PI*t)))*y[1]*(y[5]+m2) +(b01*(1+e*cos(2*M_PI*t)))*y[2]*(y[4]+m1) -u*y[3];
